(function () {
    ...
    function RequestFormService($q, $http, API_BACKEND, UserService) {
        var service = {
        ...
        function getRequestIdentificacion(form) {
            ...
            if (form.ver != undefined) {
                ...
                url = "agreementType=" + agreementType + '&participantId=' + participantId;
            } else {
                form.ver = 0;
                n = form.identificationNumber.length;
                t = 15 - n;
        ...
        function getRequestDescription(form) {
            ...
            var url = 'agreementType=' + agreementType + '&observa=' + observa;
