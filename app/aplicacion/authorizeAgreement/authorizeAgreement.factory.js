(function () {
    ...
    function AuthorizeAgreementService($q, $http, API_BACKEND, UserService, $sessionStorage) {
        ...
        function getGeneralData() {
            ...
            requestGeneralData.classAgreement = agrement.data.agreementClass.name;
            requestGeneralData.agreementNumber = agrement.data.agreementClass.name.substring(3, agrement.data.idAgreement.length - 3);
