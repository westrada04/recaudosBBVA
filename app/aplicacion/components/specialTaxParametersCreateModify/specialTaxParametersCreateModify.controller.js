(function () {
    ...
    angular
        ...
        .controller('SpecialTaxParametersCreateModifyController', SpecialTaxParametersCreateModifyController);

    function SpecialTaxParametersCreateModifyController(SpecialTaxParametersCreateModifyService, ConsultAgreementService, GeneralDataCreateModifyControllerService, toastr) {
        var vm = this;
        ...
        function save() {
            ...
            vm.myPromise = SpecialTaxParametersCreateModifyService.createIndicatorGen(requestRefundwaitDept, requestRefundwaitDept.name)
                .then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestDeliveryPeriod, requestDeliveryPeriod.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestAdditionalValue, requestAdditionalValue.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestSelf_Adhesive, requestSelf_Adhesive.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestSizeSelf_Adhesive, requestSizeSelf_Adhesive.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestReciprocity, requestReciprocity.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestDispersion, requestDispersion.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestDerrama, requestDerrama.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestDaysDepto, requestDaysDepto.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestDaysMunic, requestDaysMunic.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestDaysAgreem, requestDaysAgreem.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestTypeDaysDepto, requestTypeDaysDepto.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestTypeDaysMunic, requestTypeDaysMunic.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestTypeDaysAgreem, requestTypeDaysAgreem.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestPercentDaysDepto, requestPercentDaysDepto.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestPercentDaysMunic, requestPercentDaysMunic.name);
                }).then(function (response) {
                    return SpecialTaxParametersCreateModifyService.createIndicatorGen(requestPercentDaysAgreem, requestPercentDaysAgreem.name);
                }).then(function (response) {
