(function () {
    ...
    angular
        ...
        .factory('AccountsReceivableCreateModifyService', AccountsReceivableCreateModifyService);

    function AccountsReceivableCreateModifyService($q, $http, API_BACKEND, UserService, CreateModifyAgreementService) {
