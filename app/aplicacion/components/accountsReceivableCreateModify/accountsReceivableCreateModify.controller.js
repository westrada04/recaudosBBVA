(function () {
    ...
    angular
        ...
        .controller('AccountsReceivableCreateModifyController', AccountsReceivableCreateModifyController);

    function AccountsReceivableCreateModifyController(ConsultAgreementService, GeneralDataCreateModifyControllerService, AccountsReceivableCreateModifyService, toastr) {
        var vm = this;
        ...
        function save() {
            ...
            var myPromise = AccountsReceivableCreateModifyService.createAgreement(requestAgrement)
