(function () {
    ...
    angular
        ...
        .controller('OutputFileEditController', OutputFileEditController);

    function OutputFileEditController($scope, ConsultAgreementService, OutputFileEditService, GeneralDataEditService, toastr) {
        var vm = this;
