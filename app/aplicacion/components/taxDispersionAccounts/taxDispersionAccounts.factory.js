(function () {
    ...
    angular
        ...
        .factory('TaxDispersionAccountsService', TaxDispersionAccountsService);

    function TaxDispersionAccountsService($q, $http, API_BACKEND, UserService, CreateAgreementService) {
