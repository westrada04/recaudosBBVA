(function () {
    ...
    angular
        ...
        .controller('PayTimeAuthorizerController', PayTimeAuthorizerController);

    function PayTimeAuthorizerController(PayTimeEditService, toastr, GeneralDataEditService, ConsultAgreementService) {
        var vm = this;
        ...
        function save() {
            ...
            var myPromise = PayTimeEditService.createIndicatorGeneral(requestValidationBD, requestValidationBD.name)
                .then(function (response) {
                    ...
                    return PayTimeEditService.createIndicatorGeneral(requestReference_Fixed, requestReference_Fixed.name);
                }).then(function (response) {
                    return PayTimeEditService.createIndicatorGeneral(requestBilling_Type, requestBilling_Type.name);
                }).then(function (response) {
                    ...
                    return PayTimeEditService.createIndicatorGeneral(requestOverdue_Payment, requestOverdue_Payment.name);
                }).then(function (response) {
