(function () {
    ...
    angular
        ...
        .factory('PayTimeAuthorizerService', PayTimeAuthorizerService);

    function PayTimeAuthorizerService($q, $http, API_BACKEND, $sessionStorage, UserService, EditAgreementService) {
