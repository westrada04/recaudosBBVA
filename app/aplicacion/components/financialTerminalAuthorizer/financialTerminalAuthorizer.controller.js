(function () {
    ...
    angular
        ...
        .controller('FinancialTerminalAuthorizerController', FinancialTerminalAuthorizerController);

    function FinancialTerminalAuthorizerController(FinancialTerminalEditService, ConsultAgreementService, GeneralDataEditService, toastr) {
        var vm = this;
        vm.offices = [];
