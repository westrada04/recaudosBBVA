(function () {
    ...
    angular
        ...
        .factory('FinancialTerminalAuthorizerService', FinancialTerminalAuthorizerService);

    function FinancialTerminalAuthorizerService($q, $http, API_BACKEND, $sessionStorage, UserService, EditAgreementService) {
