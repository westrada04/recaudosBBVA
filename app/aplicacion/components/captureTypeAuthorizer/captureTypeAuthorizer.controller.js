(function () {
    ...
    angular
        ...
        .controller('CaptureTypeAuthorizerController', CaptureTypeAuthorizerController);

    function CaptureTypeAuthorizerController($scope, ConsultAgreementService, CaptureTypeEditService, GeneralDataEditService, toastr) {
        var vm = this;
