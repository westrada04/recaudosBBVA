(function () {
    ...
    angular
        ...
        .factory('CaptureTypeAuthorizerService', CaptureTypeAuthorizerService);

    function CaptureTypeAuthorizerService($q, $http, API_BACKEND, UserService, EditAgreementService) {
