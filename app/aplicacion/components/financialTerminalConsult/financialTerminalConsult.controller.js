(function () {
    ...
    angular
        ...
        .controller('FinancialTerminalConsultController', FinancialTerminalConsultController);

    function FinancialTerminalConsultController(FinancialTerminalService, ConsultAgreementService, toastr) {
        var vm = this;
        var requestFinancialTer = ConsultAgreementService.getFinancialTerminal();

        vm.type = requestFinancialTer.type;
        vm.allOffices = requestFinancialTer.allOffices;
        vm.offices = requestFinancialTer.offices;
        vm.statusOffice = requestFinancialTer.statusOffice;
