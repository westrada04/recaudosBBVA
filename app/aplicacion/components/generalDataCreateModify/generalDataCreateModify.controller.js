(function () {
    ...
    angular
        ...
        .controller('GeneralDataCreateModifyController', GeneralDataCreateModifyController);

    function GeneralDataCreateModifyController($scope, ConsultAgreementService, GeneralDataCreateModifyControllerService, toastr, CreateModifyAgreementService) {
        var vm = this;
        ...
        function deletePaymentMethodSelected(paymentMethod) {
            ...
            vm.myPromise = GeneralDataCreateModifyControllerService.createIndicatorGeneral(requestDelPaymentM, requestDelPaymentM.name)
        ...
        function save() {
            ...
            if (GeneralDataCreateModifyControllerService.getRequestAgreement().idAgreement == undefined) {

                var requestAgreement = {
                    "idAgreement": request.IdAgreement,
                    "agreementType": {
                        "id": request.IdAgreement,
                ...
                var requestAgreement = GeneralDataCreateModifyControllerService.getRequestAgreement();
            ...
            vm.myPromise = GeneralDataCreateModifyControllerService.createAgreement(requestAgreement)
                .then(function (response) {
                    CreateModifyAgreementService.setIdAgreement(response.data.idAgreement);
                    ...
                    GeneralDataCreateModifyControllerService.setRequestAgreement(requestAgreement);
                    toastr.info('Solicitud modificada con exito.<br> Solicitud : ' + response.data.idAgreement, 'Informacion !');
                    return GeneralDataCreateModifyControllerService.createIndicatorListGneral(requestPaymentMethods, 'PAYMENT_METHOD');
                }).then(function (response) {
                    return GeneralDataCreateModifyControllerService.createIndicatorGeneral(requestWaitingAccount, 'EXTRACT_PAYMENT');
                }).then(function (response) {
                    return GeneralDataCreateModifyControllerService.createIndicatorGeneral(requestMassiveActive, 'BULK_ACTIVE');
                    //   }).then(function (response) {
                    //        return GeneralDataCreateModifyControllerService.createIndicatorGeneral(requestInHouse, 'IN_HOUSE');
                }).then(function (response) {
                    return GeneralDataCreateModifyControllerService.createIndicatorGeneral(requestConsecutive, 'CONSECUTIVE');
                }).then(function (response) {
                    return GeneralDataCreateModifyControllerService.createIndicatorGeneral(requestMultilote, 'MULTILOTE');
                }).then(function (response) {
                    return GeneralDataCreateModifyControllerService.createIndicatorGeneral(requestDocumentTraffic, 'TRAFFIC_DOCUMENTS');
                }).then(function (response) {
                    return GeneralDataCreateModifyControllerService.createIndicatorGeneral(requestWebService, 'WS_UNIFICATION');
                }).then(function () {
