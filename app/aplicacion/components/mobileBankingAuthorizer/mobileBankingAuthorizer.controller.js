(function () {
    ...
    angular
        ...
        .controller('MobileBankingAuthorizerController', MobileBankingAuthorizerController);

    function MobileBankingAuthorizerController(MobileBankingEditService, ReferenceInformationEditService, toastr, GeneralDataEditService, ConsultAgreementService, $scope) {
        var vm = this;
