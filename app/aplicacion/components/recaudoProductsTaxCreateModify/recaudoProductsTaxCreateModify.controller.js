(function () {
    ...
    angular
        ...
        .controller('RecaudoProductsTaxCreateModifyController', RecaudoProductsTaxCreateModifyController);

    function RecaudoProductsTaxCreateModifyController(RecaudoProductsTaxCreateModifyService, GeneralDataCreateModifyControllerService, toastr) {
        var vm = this;
        ...
        function save() {
            ...
            vm.myPromise = RecaudoProductsTaxCreateModifyService.createIndicatorGen(requestProduct, requestProduct.name)
                .then(function (repsonse) {
                    return RecaudoProductsTaxCreateModifyService.createIndicatorGen(requestBy_Product, requestBy_Product.name);
