(function () {
    ...
    function RecaudoProductsTaxEditController(RecaudoProductsTaxEditService, GeneralDataEditService, toastr) {
        ...
        function save() {
            ...
            vm.myPromise = RecaudoProductsTaxEditService.createIndicatorGen(requestProduct, requestProduct.name)
                .then(function (repsonse) {
                    return RecaudoProductsTaxEditService.createIndicatorGen(requestBy_Product, requestBy_Product.name);
