(function () {
    ...
    function CaptureTypeController($scope, CreateAgreementService, CaptureTypeService, GeneralDataService, toastr) {
        var vm = this;
        ...
        function save() {
            ...
            var myPromise = CaptureTypeService.createAgreement(requestAgrement)
                .then(function (response) {
                    ...
                    return GeneralDataService.createIndicatorGeneral(requestCaptureType, requestCaptureType.name);
                }).then(function () {
