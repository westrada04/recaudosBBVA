(function () {
    ...
    angular
        ...
        .controller('BbvaNetBbvaCashAuthorizerController', BbvaNetBbvaCashAuthorizerController);

    function BbvaNetBbvaCashAuthorizerController(GeneralDataEditService, toastr, BbvaNetBbvaCashEditService) {
        var vm = this;
