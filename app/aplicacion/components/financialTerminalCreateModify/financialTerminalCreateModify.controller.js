(function () {
    ...
    angular
        ...
        .controller('FinancialTerminalCreateModifyController', FinancialTerminalCreateModifyController);

    function FinancialTerminalCreateModifyController(FinancialTerminalCreateModifyService, ConsultAgreementService, GeneralDataCreateModifyControllerService, toastr) {
        var vm = this;
        vm.offices = [];
        ...
        function save() {
            ...
            vm.myPromise = FinancialTerminalCreateModifyService.createIndicatorGeneral(requestOffices, requestOffices.name)
