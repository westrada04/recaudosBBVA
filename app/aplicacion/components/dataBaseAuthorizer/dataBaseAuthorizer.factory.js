(function () {
    ...
    angular
        ...
        .factory('DataBaseAuthorizerService', DataBaseAuthorizerService);

    function DataBaseAuthorizerService($q, $http, API_BACKEND, $sessionStorage, UserService, EditAgreementService) {
