(function () {
    ...
    angular
        ...
        .controller('GeneralDataAuthorizerController', GeneralDataAuthorizerController);

    function GeneralDataAuthorizerController($scope, EditAgreementService, GeneralDataEditService, toastr, ConsultAgreementService) {
        var vm = this;
