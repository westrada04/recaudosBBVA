(function () {
    ...
    angular
        ...
        .factory('GeneralDataAuthorizerService', GeneralDataAuthorizerService);

    function GeneralDataAuthorizerService($q, $http, API_BACKEND, $sessionStorage, UserService, EditAgreementService) {
