(function () {
    ...
    angular
        ...
        .controller('RecaudoProductsTaxController', RecaudoProductsTaxController);

    function RecaudoProductsTaxController(RecaudoProductsTaxService, GeneralDataService, toastr) {
        var vm = this;
