(function () {
    ...
    angular
        ...
        .factory('RecaudoProductsTaxService', RecaudoProductsTaxService);

    function RecaudoProductsTaxService($q, $http, API_BACKEND, $sessionStorage, UserService, CreateAgreementService) {
