(function () {
    ...
    angular
        ...
        .factory('ReferenceInformationAuthorizerService', ReferenceInformationAuthorizerService);

    function ReferenceInformationAuthorizerService($q, $http, API_BACKEND, $sessionStorage, UserService, EditAgreementService) {
