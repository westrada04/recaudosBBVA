(function () {
    ...
    angular
        ...
        .controller('ReferenceInformationAuthorizerController', ReferenceInformationAuthorizerController);

    function ReferenceInformationAuthorizerController(ConsultAgreementService, toastr, ReferenceInformationEditService, OutputFileEditService, $scope) {
        var vm = this;
