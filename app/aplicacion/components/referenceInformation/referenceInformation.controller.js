    ...
    function ReferenceInformationController(CreateAgreementService, ConsultAgreementService, toastr, ReferenceInformationService, OutputFileService, GeneralDataService, $scope, $rootScope) {
        ...
        function deleteReference(index) {
            ...
            if (referenceId != '01000') {
                vm.myPromiseReference = ReferenceInformationService.deleteReference(referenceId)
        ...
        function deleteAdditional(index) {
            ...
            if (referenceId != '02000') {
                vm.myPromiseAdditional = ReferenceInformationService.deleteReference(referenceId)
                    .then(function (response) {
        ...
        function deleteFixedValue(index) {
            ...
            if (referenceId != '05000') {
                vm.myPromiseFixedValue = ReferenceInformationService.deleteReference(referenceId)
                    .then(function (response) {
        ...
        function deleteValue(index) {
            ...
            if (referenceId != '03000') {
                vm.myPromiseValue = ReferenceInformationService.deleteReference(referenceId)
                    .then(function (response) {
            ...
            if (vm.stateReference) {
                ...
                angular.forEach(vm.additionals, function (value, key) {
                    ...
                    requestAdditionals.push({
                        ...
                        "positionInitial": value.inputPosition,
                        "positionOut": value.outputPosition,
                        "paddingCharacters": value.fillCharacter, // esta mal en front antiguo verificar valor  value.fillCharacter siempre envia 2 en front viejo
                        "indicator": [{
                            "id": "",
                            "indicatorId": "",
                            "name": "",
                ...
                function crearReferencia(indice) {
                    if (indice < requestInformationMessage.length) {
                        vm.myPromiseMessage = ReferenceInformationService.createMessage(requestInformationMessage[indice])
                            .then(function (response) {
                                toastr.info('Referencia almacenada Exitosamente.', 'Informacion!');
