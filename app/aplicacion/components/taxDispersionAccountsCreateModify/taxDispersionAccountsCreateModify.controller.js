(function () {
    ...
    angular
        ...
        .controller('TaxDispersionAccountsCreateModifyController', TaxDispersionAccountsCreateModifyController);

    function TaxDispersionAccountsCreateModifyController(TaxDispersionAccountsCreateModifyService, GeneralDataCreateModifyControllerService, toastr, ConsultAgreementService) {
        var vm = this;
        ...
        function save() {
            ...
            var myPromise = TaxDispersionAccountsCreateModifyService.createAgreement(requestAgrement)
