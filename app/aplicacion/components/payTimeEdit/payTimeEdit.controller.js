(function () {
    ...
    angular
        ...
        .controller('PayTimeEditController', PayTimeEditController);

    function PayTimeEditController(PayTimeEditService, toastr, GeneralDataEditService, ConsultAgreementService) {
        var vm = this;
