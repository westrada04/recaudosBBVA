(function () {
    ...
    angular
        ...
        .factory('CaptureTypeCreateModifyService', CaptureTypeCreateModifyService);

    function CaptureTypeCreateModifyService($q, $http, API_BACKEND, UserService, CreateModifyAgreementService) {
