(function () {
    ...
    angular
        ...
        .controller('CaptureTypeCreateModifyController', CaptureTypeCreateModifyController);

    function CaptureTypeCreateModifyController($scope, ConsultAgreementService, CaptureTypeCreateModifyService, GeneralDataCreateModifyControllerService, toastr) {
        var vm = this;
        ...
        function save() {
            ...
            var myPromise = CaptureTypeCreateModifyService.createAgreement(requestAgrement)
                .then(function (response) {
                    toastr.info('Registro Exitoso!', 'Informacion !');
                    GeneralDataCreateModifyControllerService.setRequestAgreement(requestAgrement);
                    return GeneralDataCreateModifyControllerService.createIndicatorListGneral(dataIndicators, 'ASSOCIATE_AGREEMENT');
                }).then(function (response) {
                    return GeneralDataCreateModifyControllerService.createIndicatorGeneral(requestCaptureType, requestCaptureType.name);
                }).then(function (response) {
