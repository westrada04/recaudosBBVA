(function () {
    ...
    angular
        ...
        .controller('PinGenerationController', PinGenerationController);

    function PinGenerationController(GeneralDataService, PinGenerationService, toastr) {
        var vm = this;
        ...
        function save() {
            ...
            var myPromise = PinGenerationService.createAgreement(requestAgrement)
