(function () {
    ...
    angular
        ...
        .factory('SpecialTaxParametersService', SpecialTaxParametersService);

    function SpecialTaxParametersService($q, $http, API_BACKEND, $sessionStorage, UserService, CreateAgreementService) {
