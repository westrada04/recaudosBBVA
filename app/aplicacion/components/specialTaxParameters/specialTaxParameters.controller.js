(function () {
    ...
    angular
        ...
        .controller('SpecialTaxParametersController', SpecialTaxParametersController);

    function SpecialTaxParametersController(SpecialTaxParametersService, GeneralDataService, toastr) {
        var vm = this;
        vm.save = save;
        ...
        function save() {
            ...
            vm.myPromise = SpecialTaxParametersService.createIndicatorGen(requestRefundwaitDept, requestRefundwaitDept.name)
                .then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestDeliveryPeriod, requestDeliveryPeriod.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestAdditionalValue, requestAdditionalValue.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestSelf_Adhesive, requestSelf_Adhesive.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestSizeSelf_Adhesive, requestSizeSelf_Adhesive.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestReciprocity, requestReciprocity.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestDispersion, requestDispersion.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestDerrama, requestDerrama.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestDaysDepto, requestDaysDepto.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestDaysMunic, requestDaysMunic.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestDaysAgreem, requestDaysAgreem.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestTypeDaysDepto, requestTypeDaysDepto.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestTypeDaysMunic, requestTypeDaysMunic.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestTypeDaysAgreem, requestTypeDaysAgreem.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestPercentDaysDepto, requestPercentDaysDepto.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestPercentDaysMunic, requestPercentDaysMunic.name);
                }).then(function (response) {
                    return SpecialTaxParametersService.createIndicatorGen(requestPercentDaysAgreem, requestPercentDaysAgreem.name);
                }).then(function (response) {
