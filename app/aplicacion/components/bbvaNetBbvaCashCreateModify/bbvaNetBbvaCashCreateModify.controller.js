(function () {
    ...
    function BbvaNetBbvaCashCreateModifyController(GeneralDataCreateModifyControllerService, ReferenceInformationCreateModifyService, toastr, BbvaNetBbvaCashCreateModifyService, ConsultAgreementService) {
        var vm = this;
        ...
        */
        ...
        function save() {
            ...
            var myPromise = BbvaNetBbvaCashCreateModifyService.createAgreement(requestAgrement)
                .then(function (response) {
                    toastr.info('Registro Exitoso!', 'Informacion !');
                    GeneralDataCreateModifyControllerService.setRequestAgreement(requestAgrement);
                    return BbvaNetBbvaCashCreateModifyService.createReferences(referencesRequest);
                }).then(function (response) {
                    localReference = [];
