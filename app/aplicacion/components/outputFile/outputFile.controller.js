(function () {
    ...
    function OutputFileController($scope, CreateAgreementService, OutputFileService, GeneralDataService, toastr) {
        var vm = this;
        ...
        function changeOutputFileType() {
            OutputFileService.setOutputFileType(vm.outputFileType);
        }
        ...
        function save() {
            ...
            if (vm.fileGeneration) {
                ...
                vm.myPromise = OutputFileService.createIndicatorGeneral(requestReport_Frecuency, 'REPORT_FREQUENCY')
                    .then(function (repsonse) {
                        return OutputFileService.createIndicatorGeneral(requestUpdate_Cyclos, 'UPDATE_CYCLOS');
                    }).then(function (response) {
                        return OutputFileService.createIndicatorGeneral(requestDelivery_Frequency, 'DELIVERY_FREQUENCY');
                    }).then(function (response) {
                        return OutputFileService.createIndicatorGeneral(requestGeneration_File, 'GENERATION_FILE');
                    }).then(function (response) {
                        return OutputFileService.createIndicatorGeneral(requestSpecial_Agreement, 'SPECIAL_AGREEMENT');
                    }).then(function (response) {
                        return OutputFileService.createIndicatorGeneral(requestChannel_Repor, 'CHANNEL_REPORT');
                    }).then(function (response) {
                        return OutputFileService.createIndicatorGeneral(requestMinimum_Periodicity, 'MINIMUM_PERIODICITY');
                    }).then(function (response) {
                        return OutputFileService.createIndicatorGeneral(requestSend_Automatic_Archi, 'SEND_AUTOMATIC_ARCHI');
                    }).then(function (response) {
                        return OutputFileService.createIndicatorGeneral(requestStructure, 'STRUCTURE');
                    }).then(function (response) {
                        return OutputFileService.createIndicatorGeneral(requestOutput_Format, 'OUTPUT_FORMAT');
                    }).then(function (response) {
                        return OutputFileService.createIndicatorGeneral(requestDestination_Output_F, 'DESTINATION_OUTPUT_F');
                    }).then(function (response) {
                        return OutputFileService.createIndicatorGeneral(requestOutput_Bd_Input_Posi, 'OUTPUT_BD_INPUT_POSI');
                    }).then(function (response) {
                        return OutputFileService.createIndicatorGeneral(requestLenght, 'LENGTH');
                    }).then(function (response) {
                        if (vm.statusAutoSendFile) {
                            return OutputFileService.createAgreement(requestAgrement);
                        } else {
                            return true;
                        }
                    }).then(function (response) {
                ...
                vm.myPromise = OutputFileService.createIndicatorGeneral(requestGeneration_File, requestGeneration_File.name)
                    .then(function (response) {
