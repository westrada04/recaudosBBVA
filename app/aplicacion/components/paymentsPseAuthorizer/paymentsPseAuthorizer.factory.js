(function () {
    ...
    angular
        ...
        .factory('PaymentsPseAuthorizerService', PaymentsPseAuthorizerService);

    function PaymentsPseAuthorizerService($q, $http, API_BACKEND, $sessionStorage, UserService, EditAgreementService) {
