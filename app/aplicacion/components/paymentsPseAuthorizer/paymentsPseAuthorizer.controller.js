(function () {
    ...
    angular
        ...
        .controller('PaymentsPseAuthorizerController', PaymentsPseAuthorizerController);

    function PaymentsPseAuthorizerController(PaymentsPseEditService, toastr, GeneralDataEditService, ConsultAgreementService) {
        var vm = this;
