(function () {
    ...
    angular
        ...
        .factory('DataBaseCreateModifyService', DataBaseCreateModifyService);

    function DataBaseCreateModifyService($q, $http, API_BACKEND, $sessionStorage, UserService, CreateModifyAgreementService) {
