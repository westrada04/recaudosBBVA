(function () {
    ...
    angular
        ...
        .factory('FinancialTerminalService', FinancialTerminalService);

    function FinancialTerminalService($q, $http, API_BACKEND, $sessionStorage, UserService, CreateAgreementService) {
