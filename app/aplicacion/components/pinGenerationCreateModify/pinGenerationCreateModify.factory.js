(function () {
    ...
    angular
        ...
        .factory('PinGenerationCreateModifyService', PinGenerationCreateModifyService);

    function PinGenerationCreateModifyService($q, $http, API_BACKEND, UserService, CreateModifyAgreementService) {
