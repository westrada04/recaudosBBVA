(function () {
    ...
    angular
        ...
        .controller('PinGenerationCreateModifyController', PinGenerationCreateModifyController);

    function PinGenerationCreateModifyController(GeneralDataCreateModifyControllerService, PinGenerationCreateModifyService, toastr, ConsultAgreementService) {
        var vm = this;
        ...
        function save() {
            ...
            var myPromise = PinGenerationCreateModifyService.createAgreement(requestAgrement)
