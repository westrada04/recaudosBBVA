(function () {
    ...
    angular
        ...
        .controller('outputFileCreateModifyController', outputFileCreateModifyController);

    function outputFileCreateModifyController($scope, ConsultAgreementService, OutputFileCreateModifyService, GeneralDataCreateModifyControllerService, toastr) {
        var vm = this;
        ...
        function changeOutputFileType() {
            OutputFileCreateModifyService.setOutputFileType(vm.outputFileType);
        }
        ...
        function save() {
            ...
            if (vm.fileGeneration) {
                ...
                vm.myPromise = OutputFileCreateModifyService.createIndicatorGeneral(requestReport_Frecuency, 'REPORT_FREQUENCY')
                    .then(function (repsonse) {
                        return OutputFileCreateModifyService.createIndicatorGeneral(requestUpdate_Cyclos, 'UPDATE_CYCLOS');
                    }).then(function (response) {
                        return OutputFileCreateModifyService.createIndicatorGeneral(requestDelivery_Frequency, 'DELIVERY_FREQUENCY');
                    }).then(function (response) {
                        return OutputFileCreateModifyService.createIndicatorGeneral(requestGeneration_File, 'GENERATION_FILE');
                    }).then(function (response) {
                        return OutputFileCreateModifyService.createIndicatorGeneral(requestSpecial_Agreement, 'SPECIAL_AGREEMENT');
                    }).then(function (response) {
                        return OutputFileCreateModifyService.createIndicatorGeneral(requestChannel_Repor, 'CHANNEL_REPORT');
                    }).then(function (response) {
                        return OutputFileCreateModifyService.createIndicatorGeneral(requestMinimum_Periodicity, 'MINIMUM_PERIODICITY');
                    }).then(function (response) {
                        return OutputFileCreateModifyService.createIndicatorGeneral(requestSend_Automatic_Archi, 'SEND_AUTOMATIC_ARCHI');
                    }).then(function (response) {
                        return OutputFileCreateModifyService.createIndicatorGeneral(requestStructure, 'STRUCTURE');
                    }).then(function (response) {
                        return OutputFileCreateModifyService.createIndicatorGeneral(requestOutput_Format, 'OUTPUT_FORMAT');
                    }).then(function (response) {
                        return OutputFileCreateModifyService.createIndicatorGeneral(requestDestination_Output_F, 'DESTINATION_OUTPUT_F');
                    }).then(function (response) {
                        return OutputFileCreateModifyService.createIndicatorGeneral(requestOutput_Bd_Input_Posi, 'OUTPUT_BD_INPUT_POSI');
                    }).then(function (response) {
                        return OutputFileCreateModifyService.createIndicatorGeneral(requestLenght, 'LENGTH');
                    }).then(function (response) {
                        if (vm.statusAutoSendFile) {
                            return OutputFileCreateModifyService.createAgreement(requestAgrement);
                        } else {
                            return true;
                        }
                    }).then(function (response) {
                ...
                vm.myPromise = OutputFileCreateModifyService.createIndicatorGeneral(requestGeneration_File, requestGeneration_File.name)
                    .then(function (response) {
